...
class Kubespider:
    ...
    def run_period_job_scheduler(self) -> None:
        logging.info("Period Server scheduler start running...")
        period_server.kubespider_period_server.run_scheduler()
    ...
    def run(self) -> None:
        _thread.start_new_thread(self.run_period_job_scheduler, ())
